...
class RunDetection extends Component {
	...
	handleStartAnalysis = () => {
		...
		makeApiServiceProxyRequest('animals/analysis/run', 'post', body, 
			(data) => {
	...
	render() {
		...
		return (
			<div className="container my-5">
				{detectionIdForRedirect && (<Redirect to={`/app/detection/${detectionIdForRedirect}`} />)}
				<div className="card">
